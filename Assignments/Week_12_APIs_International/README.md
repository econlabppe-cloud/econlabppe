...
{{< video [https://www.youtube.com/watch?v=R67XsEXXGQ8](https://www.youtube.com/watch?v=R67XsEXXGQ8) >}}
## 🟡 רמת ביניים
**העמקה ופרקטיקה מעשית:**
{{< video [https://www.youtube.com/watch?v=aIQeXN1H_0M](https://www.youtube.com/watch?v=aIQeXN1H_0M) >}}
## 🔴 רמת מתקדמים
**מקרי קצה, אופטימיזציה ושימושים מורכבים:**
{{< video [https://www.youtube.com/watch?v=x9q8T9tQ4p8](https://www.youtube.com/watch?v=x9q8T9tQ4p8) >}}
:::
...
<iframe src="https://colab.research.google.com/github/econlabppe-cloud/econlabppe/blob/main/Assignments/Week_12_APIs_International/starter_notebook.ipynb" width="100%" height="600" frameborder="0" allowfullscreen></iframe>
<p><br><em>* אם המסך לא נטען או מבקש הרשאות אבטחה, <a href="https://colab.research.google.com/github/econlabppe-cloud/econlabppe/blob/main/Assignments/Week_12_APIs_International/starter_notebook.ipynb" target="_blank">לחצו כאן לפתיחת המחברת במסך מלא</a>.</em></p>
---
### 🧠 בחן את עצמך (שאלות סיכום)
עכשיו כשאתם יודעים למשוך נתוני מאקרו מ-FRED ומהבורסה, ודאו שאתם מבינים את כללי המשחק:

<details>
<summary><b>שאלה 1: מהו API Key ולמה לעולם אסור להעלות אותו ל-GitHub הציבורי שלכם?</b> 👁️ לחץ לתשובה</summary>
<br>
<b>API Key</b> הוא סיסמה אישית שהשרת (כמו FRED או בנק ישראל) מעניק לכם כדי לזהות מי שואב ממנו נתונים ולעקוב אחרי מכסת השימוש. אם תעלו אותו בטעות לגיטהאב, האקרים יוכלו לסרוק את הקוד שלכם, לגנוב את המפתח, ולהשתמש בו כדי להעמיס על השרתים או לחייב אתכם בכסף (אם מדובר בשירות בתשלום).
</details>

<details>
<summary><b>שאלה 2: למה הגישה של שאיבת נתונים דרך API עדיפה על פני עבודה עם קבצי CSV סטטיים במחקר כלכלי?</b> 👁️ לחץ לתשובה</summary>
<br>
היתרון העצום הוא <b>שחזור ואוטומציה (Reproducibility)</b>. קובץ CSV הופך למיושן ברגע שהורדתם אותו. קוד שמושך נתונים מ-API יביא תמיד את הנתונים המעודכנים ביותר נכון לרגע ההרצה, בלי שתצטרכו לשנות אפילו פסיק בקוד שלכם.
</details>
